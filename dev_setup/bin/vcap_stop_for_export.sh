...
sudo apt-get purge autoconf automake autotools-dev build-essential cmap-adobe-japan1 comerr-dev consolekit cryptsetup-bin dbus-x11 dconf-gsettings-backend dconf-service dpkg-dev fakeroot fontconfig gconf-service gconf-service-backend gconf2 gconf2-common ghostscript gs-cjk-resource gsfonts gvfs gvfs-common gvfs-daemons gvfs-libs hicolor-icon-theme icedtea-7-jre-jamvm iftop imagemagick-common krb5-multidev libalgorithm-diff-perl libalgorithm-diff-xs-perl libalgorithm-merge-perl libasound2 libasyncns0 libatasmart4 libatk-wrapper-java libatk-wrapper-java-jni libatk1.0-0 libatk1.0-data libavahi-glib1 libbonobo2-0 libbonobo2-common libc-dev-bin libc6-dev libcairo-gobject2 libcairo2 libcanberra0 libck-connector0 libcryptsetup4 libcupsimage2 libcurl4-openssl-dev libdatrie1 libdconf0 libdevmapper-event1.02.1 libdpkg-perl libffi-dev libflac8 libfontenc1 libgconf-2-4 libgconf2-4 libgcrypt11-dev libgdk-pixbuf2.0-0 libgdk-pixbuf2.0-common libgdu0 libgif4 libgl1-mesa-dri libgl1-mesa-glx libglapi-mesa libgnome-keyring-common libgnome-keyring0 libgnome2-0 libgnome2-bin libgnome2-common libgnomevfs2-0 libgnomevfs2-common libgnutls-dev libgnutls-openssl27 libgnutlsxx27 libgpg-error-dev libgs9 libgs9-common libgssrpc4 libgtk-3-0 libgtk-3-bin libgtk-3-common libgtk2.0-0 libgtk2.0-bin libgtk2.0-common libice-dev libice6 libidl-common libidl0 libidn11-dev libijs-0.35 libjasper1 libjbig2dec0 libjson0 libkadm5clnt-mit8 libkadm5srv-mit8 libkdb5-6 libkrb5-dev liblcms1 libldap2-dev libllvm3.0 liblqr-1-0 libltdl-dev libltdl7 liblvm2app2.2 libmagickcore4 libncurses5-dev libnss-mdns libogg0 liborbit2 libp11-kit-dev libpam-ck-connector libpango1.0-0 libpaper-utils libpaper1 libpixman-1-0 libpolkit-agent-1-0 libpolkit-backend-1-0 libpq-dev libpthread-stubs0 libpthread-stubs0-dev libpulse0 libreadline6-dev librmagick-ruby librtmp-dev libsgutils2-2 libsm-dev libsm6 libsndfile1 libsqlite3-dev libssl-dev libssl-doc libtasn1-3-dev libtdb1 libthai-data libthai0 libtiff4 libtinfo-dev libtool libvorbis0a libvorbisenc2 libvorbisfile3 libx11-dev libx11-doc libx11-xcb1 libxau-dev libxaw7 libxcb-glx0 libxcb-render0 libxcb-shape0 libxcb-shm0 libxcb1-dev libxcomposite1 libxcursor1 libxdamage1 libxdmcp-dev libxfixes3 libxft2 libxi6 libxinerama1 libxmu6 libxpm4 libxrandr2 libxrender1 libxt-dev libxt6 libxtst6 libxv1 libxxf86dga1 libxxf86vm1 libyaml-dev linux-libc-dev manpages-dev mtools openjdk-7-jdk openjdk-7-jre pkg-config policykit-1 policykit-1-gnome postgresql-server-dev-9.1 python-avahi ruby rubygems ruby-dev ruby-rmagick shared-mime-info sound-theme-freedesktop ttf-dejavu-extra udisks x11-common x11-utils x11proto-core-dev x11proto-input-dev x11proto-kb-dev xorg-sgml-doctools xtrans-dev zlib1g-dev vim vim-runtime geoip-database libxslt-dev
