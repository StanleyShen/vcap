...
default[:monit][:vcap_components] = { :controller => ["cloud_controller", "health_manager", "redis_gateway", "redis_node", "router", "stager", "dns_publisher"], :db => ["mongodb_gateway", "mongodb_node", "postgresql_gateway", "postgresql_node"], :dea => ["dea"] }
