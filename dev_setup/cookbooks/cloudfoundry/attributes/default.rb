...
default[:cloudfoundry][:git][:vcap][:repo] = "https://github.com/ServiceMax-Engineering/vcap.git"
...
default[:cloudfoundry][:git][:vcap_java][:repo] = "https://github.com/ServiceMax-Engineering/vcap-java.git"
default[:cloudfoundry][:git][:vcap_java][:branch] = "master"
default[:cloudfoundry][:git][:vcap_services][:repo] = "https://github.com/ServiceMax-Engineering/vcap-services.git"
default[:cloudfoundry][:git][:vcap_services][:branch] = "4.0"

default[:cloudfoundry][:git][:router][:repo] = "https://github.com/ServiceMax-Engineering/router.git"
